...
<div class="container">
    <main>
        <section class="login">
            ...
            <form id="eliminar" method="post" class="sesion needs-validation" action="${pageContext.request.contextPath}/DocenteServlet" enctype="multipart/form-data">
                <center>
                    <label for="iddoc" style="font-weight: bold;">Número de identificador a eliminar:</label>
                ...
                <br><br>
                <center>
                    <button type="submit" onclick="inicio()" class="boton">Aceptar</button>
                </center>
            </form>
        </section>
    </main>
