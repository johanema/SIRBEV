...
<div class="container">
    <main>
        <section class="login">
            ...
            <form id="eliminar" method="post" class="sesion needs-validation" action="${pageContext.request.contextPath}/AlumnoServlet" enctype="multipart/form-data">
                <center>
                    <label for="matricula" style="font-weight: bold;">Matrícula a eliminar:</label>
