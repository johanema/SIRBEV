...
<div class="container">
    <main>
        <section class="login">
            ...
            <form id="ingresarmodificaciones" method="post" class="sesion needs-validation" action="${pageContext.request.contextPath}/DocenteServlet" enctype="multipart/form-data">
                <center>
                    <label for="iddoc" style="font-weight: bold;">Número de identificador a modificar:</label>
